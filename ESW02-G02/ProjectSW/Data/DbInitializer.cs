...
namespace ProjectSW.Data
{
    public static class DbInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            new Animal{BreedId=2, Name="Balu", Size="Pequeno", Gender="Masculino", DateOfBirth=DateTime.Parse("2010-11-11"), EntryDate=DateTime.Parse("2014-07-26"), Available=true, Foto = System.IO.File.ReadAllBytes("./wwwroot/images/poodle.jpg")},
            ...
            new Animal{BreedId=4, Name="Bobi", Size="Medio", Gender="Masculino", DateOfBirth=DateTime.Parse("2015-09-07"), EntryDate=DateTime.Parse("2019-04-11"), Available=true, Foto = System.IO.File.ReadAllBytes("./wwwroot/images/golden-retriever.jpg")},
            new Animal{BreedId=5, Name="Nala", Size="Grande", Gender="Feminino", DateOfBirth=DateTime.Parse("2010-03-01"), EntryDate=DateTime.Parse("2018-08-15"), Available=true, Foto = System.IO.File.ReadAllBytes("./wwwroot/images/pastor-alemao.jpg")},
